...
print("--- loading NuclearCraft Integration - Vanilla.zs ---");

//Fluid transposer replacement

//Concrete Recipes

val powderDef = <minecraft:concrete_powder>.definition;
val concreteDef = <minecraft:concrete>.definition;

for i in 0 to 16 {
mods.nuclearcraft.infuser.addRecipe(powderDef.makeStack(i), <liquid:water> * 1000, concreteDef.makeStack(i), 10);
}

// Obsidian recipe

mods.nuclearcraft.ingot_former.addRecipe(<liquid:lava> * 1000, <ore:obsidian>);
